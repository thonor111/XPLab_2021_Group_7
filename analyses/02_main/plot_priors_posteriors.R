...
extracted_SCT_posteriors <- data.frame(rstan::extract(fit_brms_two)[c("bIn","bBoth","bOut")], model="Self-categorization", info="posterior")
extracted_herding_posteriors <- data.frame(rstan::extract(fit_brms_one)[c("bIn","bBoth","bOut")], model="Alternative", info="posterior")
